...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-06-2023 a las 03:19:59
...
--
-- Base de datos: `sistemaclinicafinal`
--
...
--
ALTER TABLE `especialidad`
  MODIFY `IDEspecialidad` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `medicos`
  MODIFY `IDMedicos` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `medicos`
  ADD CONSTRAINT `medicos_ibfk_1` FOREIGN KEY (`IDEspecialidad`) REFERENCES `especialidad` (`IDEspecialidad`) ON DELETE CASCADE ON UPDATE CASCADE;
